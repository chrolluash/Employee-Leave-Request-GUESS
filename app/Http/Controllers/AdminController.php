...
{
    // REPLACE the dashboard() method in AdminController.php
...
public function dashboard(Request $request)
{
    ...
    switch ($sort) {
        ...
        case 'employee_az':
        case 'employee_za':
            // Load all with users, then sort in collection
            $query->with('user');
            break;
        case 'latest':
        default:
    ...
    // Sort by employee name if needed (after pagination)
    if (in_array($sort, ['employee_az', 'employee_za'])) {
        ...
        // Keep pagination but with sorted items
    ...
    // REPLACE the employees() method in AdminController.php

public function employees(Request $request)
{
    $query = User::where('role', 'employee')->withCount('leaveRequests');
    ...
    // NEW: Show create employee form
    public function createEmployee()
    {
        return view('admin.create-employee');
    }

    // NEW: Store new employee
    public function storeEmployee(Request $request)
    {
        ...
        return redirect()->route('admin.employees')
            ->with('success', 'Employee account created successfully! Login credentials have been set.');
    }

    // NEW: Show edit employee form
